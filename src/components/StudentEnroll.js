...
export default function StudentEnroll() {
    ...
    const handleSubmit = async (event) => {
        ...
        const apiUrl = 'https://decd-103-124-140-173.ngrok-free.app/api/newstudentenroll';    // PORT 8080
        try {
            ...
            if (response.status === 200||response.status === 201) {
                ...
                const trainResponse = await axios.post('https://3136-103-124-140-173.ngrok-free.app/api/train-model');  //  PORT 5000
